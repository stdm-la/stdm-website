...
const sesClient = new SESClient({
  region: process.env.STDM_REGION || 'us-east-1',
  credentials: process.env.STDM_ACCESS_KEY_ID
    ? {
        accessKeyId: process.env.STDM_ACCESS_KEY_ID,
        secretAccessKey: process.env.STDM_SECRET_ACCESS_KEY || '',
      }
